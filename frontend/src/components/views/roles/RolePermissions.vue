          ...
          <div class="box box-info box-solid">
            ...
            <div class="box-body">
              <select
                ...
                size="10"
                style="width: 100%;"
                @change="selectedRolePermissions = []"
              >
        ...
        <div class="col-sm-5">
          <div class="box box-primary box-solid">
            ...
            <div class="box-body">
              ...
              >
                <option v-for="obj in newRole.permissions" :key="obj" :value="obj">
                  {{ obj.permission.name }}
                </option>
              </select>
            </div>
...
export default {
  ...
  computed: {
    permissionDescription() {
      const permission =
        ...
        (this.selectedRolePermissions[0] || {}).permission;
      if (permission) {
    ...
    includedPermissions() {
      return this.newRole.permissions.filter(permission => {
  ...
  watch: {
    selectedIncludedPermissions(val) {
      this.selectedRolePermissions = [].concat(
        val,
  ...
  methods: {
    getAvailablePermissions() {
      this.loading = true;
      const rolePermissionIds = this.newRole.permissions.map(object => {
    ...
    sortLists() {
      this.newRole.permissions.sort((a, b) => {
    ...
    updateRolePermissions() {
      roleService
        .updateRolePermissions(this.newRole._id, this.newRole.permissions, this.oldRole.permissions)
        .then(() => {
          this.loading = false;
          this.dirty = false;
          this.oldRole = _.cloneDeep(this.newRole);
