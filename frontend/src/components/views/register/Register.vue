      ...
      <div class="container">
        ...
        <div v-show="!loading">
          ...
          <div v-if="!registerSuccess" class="col-md-4 col-md-offset-4">
            <vue-form :state="formstate" class="row" @submit.prevent="registerUser">
              ...
              <div class="flash-message">
                <div class="alert" :class="'alert-info'">
                  NOTE: Your 4 digit PIN will be required if you need to reset your password in the
    ...
    registerUser() {
      ...
      authService
        ...
        .then(() => {
          ...
          this.flashMessage =
            'Thank you for registering! Please check your email for an account activation link.';
        })
        .catch(error => {
          this.loading = false;
          this.error = true;
