<template>
  <section>
    ...
    <div v-show="!loading" class="content">
      <div ref="imageBox" class="box box-primary">
        ...
        <div v-if="ready" class="box-footer">
          <div class="row">
            <div class="content-centered">
              <button
                :disabled="(!image.hasImage() || !this.dirty) && !fileChosen"
                class="btn btn-primary"
                @click="uploadImage"
              >
                <i class="fa fa-file-picture-o" /> Upload
              </button>
            </div>
          </div>
        </div>
  ...
  methods: {
    ...
    uploadImage() {
      ...
      this.image.generateBlob(
        blob => {
          return fileService
            .uploadImage(this.imageName, blob, {
