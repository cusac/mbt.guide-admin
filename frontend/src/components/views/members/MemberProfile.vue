      ...
      <div class="col-md-3">
        ...
        <div class="box box-primary">
          <div class="box-body box-profile">
            ...
            <a
              v-if="!connection.isContact"
              v-permission.enable="['connection', 'createConnection', 'updateConnection']"
              href="#"
              :disabled="isSelf"
            ...
            <a
              ...
              class="btn btn-primary outline btn-block"
              @click="removeContact"
              ><b>Remove Contact</b></a
            >
            <a
              v-if="!connection.isFollowing"
              v-permission.enable="['connection', 'createConnection', 'updateConnection']"
              href="#"
              :disabled="isSelf"
            ...
            <a
              ...
              ><b>Unfollow</b></a
            >
            <a href="#" class="btn btn-success btn-block" :disabled="isSelf" @click="openChatBox"
              ><b>Message</b></a
            >
          </div>
          <!-- /.box-body -->
        ...
        <div class="box box-primary">
          ...
          <!-- /.box-header -->
          <div class="box-body">
            <strong><i class="fa fa-book margin-r-5" /> Education</strong>
            ...
            <strong><i class="fa fa-map-marker margin-r-5" /> Location</strong>
            ...
            <strong><i class="fa fa-pencil margin-r-5" /> Skills (Coming Soon)</strong>
            ...
            <strong><i class="fa fa-file-text-o margin-r-5" /> Bio</strong>
              ...
              <div id="activity" class="active tab-pane">
                ...
                <div class="post">
                  <div class="user-block">
                    <img
                      ...
                      src="../../../../static/img/demo/user1-128x128.jpg"
                      alt="user image"
                    />
                    <span class="username">
                  ...
                  <ul class="list-inline">
                    <li>
                      <a href="#" class="link-black text-sm"
                        ><i class="fa fa-share margin-r-5" /> Share</a
                      >
                    </li>
                    <li>
                      <a href="#" class="link-black text-sm"
                        ><i class="fa fa-thumbs-o-up margin-r-5" /> Like</a
                      >
                    </li>
                    <li class="pull-right">
                      <a href="#" class="link-black text-sm"
                        ><i class="fa fa-comments-o margin-r-5" /> Comments (5)</a
                      >
                    </li>
                  </ul>
                ...
                <div class="post clearfix">
                  <div class="user-block">
                    <img
                      class="img-circle img-bordered-sm"
                      src="../../../../static/img/demo/user7-128x128.jpg"
                      alt="User Image"
                    />
                    <span class="username">
                      <a href="#">Sarah Ross</a>
                ...
                <div class="post">
                  <div class="user-block">
                    <img
                      class="img-circle img-bordered-sm"
                      src="../../../../static/img/demo/user6-128x128.jpg"
                      alt="User Image"
                    />
                    <span class="username">
                      <a href="#">Adam Jones</a>
                  ...
                  <div class="row margin-bottom">
                    <div class="col-sm-6">
                      <img
                        ...
                        src="../../../../static/img/demo/photo1.png"
                        alt="Photo"
                      />
                    </div>
                    <!-- /.col -->
                    <div class="col-sm-6">
                      <div class="row">
                        <div class="col-sm-6">
                          <img
                            class="img-responsive"
                            src="../../../../static/img/demo/photo2.png"
                            alt="Photo"
                          />
                          <br />
                          <img
                            class="img-responsive"
                            src="../../../../static/img/demo/photo3.jpg"
                            alt="Photo"
                          />
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-6">
                          <img
                            class="img-responsive"
                            src="../../../../static/img/demo/photo4.jpg"
                            alt="Photo"
                          />
                          <br />
                          <img
...
export default {
  ...
  methods: {
    ...
    getUser() {
      ...
      promise = this.$userRepository.find(this.$route.params._id, params).then(response => {
    ...
    getConnection() {
      ...
      promise = this.$userRepository
        .getConnections(this.$store.state.auth.user._id, params)
        .then(response => {
    ...
    getConnectionStats() {
      ...
      return userService.getConnectionStats(this.$route.params._id).then(response => {
        this.loading = false;
    ...
    removeContact() {
      ...
      return this.$connectionRepository
        .update(this.connection._id, params)
        .then(response => {
          this.connection = response.data;
          this.connectionStats.contacts -= 1;
          this.loading = false;
