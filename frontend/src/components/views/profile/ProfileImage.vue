    ...
    <div class="box box-solid box-clear">
      <div class="content">
        <div class="row content-centered profile">
          ...
          >
            <img slot="initial" crossorigin="anonymous" :src="displayUrl" />
        ...
        <div v-if="ready" class="row">
          <div class="content-centered">
            <button
              :disabled="
                (!profileImage.hasImage() || profileImageUrl.includes('gravatar') || !this.dirty) &&
                  !fileChosen
              "
            ...
            <button
              :disabled="profileImageUrl.includes('gravatar') || profileLoading"
...
export default {
  ...
  methods: {
    ...
    setProfileImage() {
      ...
      this.profileImage.generateBlob(
        blob => {
          return fileService
            .uploadProfileImage(this.profileImageName, blob, {
              onUploadProgress: progressEvent => {
                this.percentCompleted = Math.floor(
    ...
    removeProfileImage() {
      ...
      this.profileImageUrl =
        'https://www.gravatar.com/avatar/' + this.$store.state.auth.user._id + '?r=PG&d=robohash';
      return userService
        .updateUserProfile({ profileImageUrl: this.profileImageUrl })
        .then(() => {
          this.loading = false;
          // Update the global user object
          const user = this.$store.state.auth.user;
