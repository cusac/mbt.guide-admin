<template>
  <section>
    ...
    <div v-show="!loading" class="content">
      <div v-if="updateRequiredMessage" class="flash-message text-center">
          ...
          <div class="tab-content content">
              ...
              <div class="col-md-12">
                <vue-form :state="formstate" class="row" @submit.prevent="onSubmit">
                  ...
                  <validate
                    auto-label
                    class="form-group"
                    :class="fieldClassName(formstate.location)"
                  >
                    <vue-form-input
                  ...
                  <validate
                    auto-label
                    class="form-group"
                    :class="fieldClassName(formstate.education)"
                  >
                    <vue-form-input
                      ...
                      :label="'Education:'"
                      :placeholder="
                        'Ex: B.S. in Computer Science from the University of Tennessee at Knoxville'
                      "
                      :name="'education'"
                      :messages="{}"
                    />
                  ...
                  <textarea
                    ...
                    class="form-control"
                    style="height:200px;"
                    placeholder="Ex: I'm an amazingly interesting person!"
                  />
                </vue-form>
            ...
            <div id="settings" class="tab-pane fade in" :class="settingsActive">
              <div class="callout callout-info">
                ...
                <p>
                  Your 4 digit PIN will be required if you need to reset your password in the
                  future. Please keep it somewhere safe.
                </p>
              </div>

              <div class="col-md-4 col-md-offset-4">
                <vue-form :state="passwordFormstate" class="row" @submit.prevent="updatePassword">
                  <validate
                    auto-label
                    class="form-group"
                    :class="fieldClassName(passwordFormstate.newPassword)"
                    :debounce="250"
                    :custom="{ notStrong: passwordScoreValidator }"
                  >
                    <vue-form-input
                      v-model="newPassword"
                      required
                      :password-formstate="passwordFormstate"
                      :type="'password'"
                      :label="'New Password:'"
                      :name="'newPassword'"
                      ...
                      :messages="{
                        required: 'This field is required',
                        notStrong: 'Password not strong enough',
                      }"
                  ...
                  <validate
                    auto-label
                    class="form-group"
                    :class="fieldClassName(passwordFormstate.confirmPassword)"
                    :debounce="250"
                    :custom="{ notMatch: passwordConfirmValidator }"
                  >
                    <vue-form-input
                  ...
                  <div class="content-centered">
                    <button
                      ...
                      :disabled="
                        passwordFormstate.$pristine ||
                          passwordFormstate.$invalid ||
                          passwordScoreUpdating
                      "
                    >
                      Update Password
                    </button>
                ...
                <vue-form :state="pinFormstate" class="row" @submit.prevent="updatePIN">
                  <validate
                    auto-label
                    class="form-group"
                    :class="fieldClassName(pinFormstate.pin)"
                    :custom="{ minlength: minlengthValidator(4) }"
                  >
                    <vue-form-input
                      v-model="pin"
                      required
                      :pin-formstate="pinFormstate"
                      :type="'text'"
                      :label="'PIN:'"
                      :name="'pin'"
                      :mask="'1111'"
                  ...
                  <div class="content-centered">
                    <button
                      ...
                      style="margin-top: 15px;"
                      :disabled="
                        pinFormstate.$pristine || pinFormstate.$invalid || passwordScoreUpdating
                      "
                    >
                      Update PIN
                    </button>
...
export default {
  ...
  created() {
    ...
    if (
      this.$store.state.auth.user.passwordUpdateRequired &&
      this.$store.state.auth.user.pinUpdateRequired
    ) {
  ...
  methods: {
    ...
    minlengthValidator(minlength) {
      ...
      return input => {
        return formService.minlengthValidator(input.split('_')[0], minlength);
      };
    },
    ...
    updateProfile() {
      this.loading = true;
      return userService
        .updateUserProfile(this.newProfile)
        .then(() => {
          this.loading = false;
          this.formstate._reset();
          this.oldProfile = _.cloneDeep(this.newProfile);
    ...
    updatePassword() {
      ...
      userService
        ...
        .then(() => {
          ...
          // Update the global user object
          const user = Object.assign(this.$store.state.auth.user, {
    ...
    deleteUser() {
      this.loading = true;
      return userService
        .deleteCurrentAccount(this.newProfile._id)
        .then(() => {
          this.loading = false;
          return swal('Deleted!', 'Your account has been deleted.', 'success');
        })
        .then(() => {
          authService.logout();
