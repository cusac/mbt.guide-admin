      ...
      <div class="col-md-6 col-md-offset-3">
        <div class="flash-message">
          <div class="alert" :class="'alert-info'">
            NOTE: This will send a reset password email to the user, however this will
            <i>NOT</i> require the user to enter their PIN, so make sure you have verified their
            identity.
          </div>
        </div>
