    ...
    <div class="box box-primary new-chat-box">
      <div class="box-header with-border">
        ...
        <div class="box-tools pull-right">
          <button class="btn btn-box-tool" @click="closeChatCreateBox">
            <i class="fa fa-times" />
          </button>
        </div>
      </div>
        ...
        <div class="add-people-box">
          <div class="search-box">
            ...
            <div class="search-result-box">
              <ul class="result-list">
                <li v-for="user in usersToAdd" :key="user._id" @click="toggleUser(user)">
                  <img class="search-result-img" :src="user.profileImageUrl" alt="Contact Avatar" />

                  <span class="search-result-name"> {{ user.firstName }} {{ user.lastName }} </span>

                  <span class="search-result-check">
                    <i v-if="user.added" class="fa fa-lg fa-check-circle-o" />
                    <i v-else="" class="fa fa-lg fa-circle-thin" />
                  </span>
                </li>
              </ul>
            </div>
          ...
          <div class="selected-people-box">
            <div class="selected-count">
              ...
              ><span class="count">{{ addedUsers.length }}</span>
            </div>

            <ul class="selected-list">
              <li v-for="user in addedUsers" :key="user._id" @click="removeUser(user)">
                <img class="selected-img" :src="user.profileImageUrl" alt="Contact Avatar" />
                <span class="selected-name"> {{ user.firstName }} {{ user.lastName }} </span>
